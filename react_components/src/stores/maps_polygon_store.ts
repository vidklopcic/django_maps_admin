...
export class MapsPolygonStore {
    ...
    constructor(djangoStore: DjangoFormStore, field: string, color: string, fillColor: string, weight: string, dashArray: string, lineCap: string, lineJoin: string) {
        this.djangoStore = djangoStore;
        this.field = field;
        this.colorField = color;
        this.fillColorField = fillColor;
    ...
    get fillColor(): string {
        return this.djangoStore.values.get(this.fillColorField);
    }
